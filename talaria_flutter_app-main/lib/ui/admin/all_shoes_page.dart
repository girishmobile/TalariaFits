...
import 'admin_individual_shoe_page.dart';
import 'admin_individual_shoes_page.dart';

class AdminAllShoesScreen extends StatefulWidget {
  const AdminAllShoesScreen({Key? key}) : super(key: key);

  @override
  _AdminAllShoesScreenState createState() => _AdminAllShoesScreenState();
}

class _AdminAllShoesScreenState extends State<AdminAllShoesScreen> {
                          ...
                          return GridView.count(
                            ...
                            children: List.generate(
                              ...
                              return SearchListWidget(
                                shoes: shoes,
                                onTap: () {
                                  Get.to(() => AdminIndividualShoesPage(
                                        shoesDataModel: shoes,
                                      ));
                                },
                              );
